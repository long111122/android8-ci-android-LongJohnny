...
import image.manual.android.demotasks.networks.service.RegisterService;
import image.manual.android.demotasks.utils.InputValidation;
...
//                    new RegisterFragment().setArguments(bundle);
    ...
    private void register() {
        RetrofitFactory
                .getInstance()
                .createService(RegisterService.class)
